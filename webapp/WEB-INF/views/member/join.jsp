...
$(document).ready(function(){
	...
	$(".join_button").click(function(){
		...
		var pwck = $('.pwck_input').val();      // 비밀번호 확인란
		var name = $('.user_input').val();      // 이름 입력란
		var mail = $('.mail_input').val();      // 메일 입력란
	...
	$('.id_input').on("propertychange change keyup paste input", function() {
		var memberId = $(this).val();   //.id_nput에 입력되는 값
	...
	$('.mail_check_button').on('click', function(){
	    ...
	    var email    = $('.mail_input').val();     // 화면에서 입력한 이메일
		...
		new daum.Postcode({
			oncomplete: function(data) {
				...
				if(data.userSelectedType ==='R') {
					...
					if(data.bname !== '' && /[동|로|가]$/g.test(daum.bname)){
